...
@page { margin: 0; }
	...
	?>
		<header>
			<h1>Invoice</h1>
			<address >
				<p>VICTORY TRAVEL CENTRE,</p>
				<p>Buganda Road,<br>Kampala,<br>Uganda.</p>
				<p>(+256)704843924</p>
			</address>
		...
		<aside>
			...
			<div >
				<p align="center">Email :- info@victorytravels.com || Web :- www.victorytravelcentre.com || Phone :- +256704843924 </p>
			</div>
		</aside>
	</body>
</html>
