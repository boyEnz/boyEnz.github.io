...
<head>
    <title>Victory Travel Centre</title>
    <!-- for-mobile-apps -->
...
<body>
        ...
        <div class="contact-bnr-w3-agile">
            <ul>
                <li><i class="fa fa-envelope" aria-hidden="true"></i><a
                        href="mailto:victorytravels@gmail.com">INFO@VICTORYTRAVEL.COM</a></li>
                <li><i class="fa fa-phone" aria-hidden="true"></i>+256704843924</li>
                <li class="s-bar">
                    <div class="search">
        ...
        <div class="container">
            <nav class="navbar navbar-default">
                <div class="navbar-header navbar-left">
                    ...
                    <h1><a class="navbar-brand" href="index.php">VICTORY <span>TRAVEL CENTRE</span>
                            <p class="logo_w3l_agile_caption">Your Trusted Travel Partner</p>
                        </a></h1>
                </div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4>VICTORY <span>TRAVEL</span></h4>
                    <img src="images/1.jpg" alt=" " class="img-responsive">
                    <h5>We know what you love</h5>
                    <p>Providing guests unique and enchanting adventures with its exceptional amenities, makes us one of
                        best tour and travel agency.Try our hotel and food menu, awesome services and friendly staff
                ...
                <ul class="cbp-ig-grid">
                    <li>
                        <div class="w3_grid_effect">
                            ...
                            <span class="cbp-ig-category">VICTORY TRAVELS</span>
                        </div>
                    </li>
                    <li>
                        <div class="w3_grid_effect">
                            <span class="cbp-ig-icon w3_cube"></span>
                            <h4 class="cbp-ig-title">INCREDIBLE ADVENTURES</h4>
                            <span class="cbp-ig-category">VICTORY TRAVELS</span>
                        </div>
                    </li>
                    <li>
    ...
    <div class="about-wthree" id="about">
        <div class="container">
            <div class="ab-w3l-spa">
                <h3 class="title-w3-agileits title-black-wthree">About VICTORY TRAVELS</h3>
                ...
                <div class="advantage-bottom">
                    <div class="col-md-6 advantage-grid left-w3ls wow bounceInLeft" data-wow-delay="0.3s">
                        <div class="advantage-block ">
                            ...
                            <h4>Enjoy the condusive atmosphere! </h4>
                    ...
                    <div class="price-block agile">
                        ...
                        <div class="price-gd-bottom">
                            ...
                            <div class="price-selet">
                                <h3><span>$</span>320</h3>
                                <a href="/tour_and_travel/admin/reservation.php">Book Now</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="contact-w3ls" id="contact">
        <div class="container">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
                ...
                <p class="contact-agile1"><strong>Phone :</strong>+256786453736</p>
                <p class="contact-agile1"><strong>Email :</strong> <a
                        href="mailto:info@victorytravels.com">INFO@VICTORYTRAVELS.COM</a></p>
                <p class="contact-agile1"><strong>Address :</strong> Buganda Road, Kampala, Uganda</p>
    ...
    <!-- /contact -->
    <div class="copy">
        <p>© 2020 VICTORY TRAVELS . All Rights Reserved | Designed by <a href="index.php">VICTORY TRAVEL CENTRE</a> </p>
    </div>
    <!--/footer -->
    <!-- js -->
